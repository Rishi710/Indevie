            ...
            <div className="absolute z-10 w-[350px] lg:w-[400px] -translate-y-1/2" style={{ right: '20%', top: '10%' }}>
              ...
              >
                ...
                <div className="pr-16 text-right w-180">
                  <p className="text-[12px] text-[#d0ba96] uppercase tracking-widest font-inter mb-3 font-semibold">01 &mdash; The Search</p>
                  <p className="text-3xl font-inter italic mb-4 text-[#f5f1e6]">Patience Required</p>
                  <p className="text-[15px] font-inter text-[#f5f1e6]/80 leading-relaxed font-light">
            ...
            <div className="absolute z-10 w-[350px] lg:w-[400px] -translate-y-1/2" style={{ left: '20%', top: '50%' }}>
              ...
              >
                ...
                <div className="pl-16 md:pl-24 w-190">
                  <p className="text-[12px] text-[#d0ba96] uppercase tracking-widest font-inter mb-3 font-semibold">02 &mdash; The Intention</p>
                  <p className="text-3xl font-inter italic mb-4 text-[#f5f1e6]">No Compromises</p>
                  <p className="text-[15px] font-inter text-[#f5f1e6]/80 leading-relaxed font-light">
            ...
            <div className="absolute z-10 w-[350px] lg:w-[400px] -translate-y-1/2" style={{ right: '40%', top: '90%' }}>
              ...
              >
                ...
                <div className="pr-16 text-right w-150">
                  <p className="text-[12px] text-[#d0ba96] uppercase tracking-widest font-inter mb-3 font-semibold">03 &mdash; The Reality</p>
                  <p className="text-3xl font-inter italic mb-4 text-[#f5f1e6]">Worth The Wait</p>
                  <p className="text-[15px] font-inter text-[#f5f1e6]/80 leading-relaxed font-light">
            ...
            {[
              ...
              >
                ...
                <div className="w-full pl-12">
                  <p className="text-[10px] text-[#d0ba96] uppercase tracking-widest font-inter mb-2 font-semibold">{item.phase} &mdash; {item.title}</p>
                  <p className="text-2xl font-inter italic mb-3 text-[#f5f1e6]">{item.title}</p>
                  <p className="text-sm font-inter text-[#f5f1e6]/70 leading-relaxed font-light">
                    {item.desc}
                  </p>
                </div>
              </motion.div>
