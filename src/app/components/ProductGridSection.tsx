  ...
  return (
    <section className="py-12 md:py-24 px-4 md:px-10 lg:px-16 bg-[#f5f1e6]">
      <div className="max-w-[1400px] mx-auto">
        <h2 className="text-2xl text-[#2a2a2a] mb-8 font-medium text-center">Our Products</h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-1 md:gap-1">
