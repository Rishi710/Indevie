      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Link href={`/blogs/${post.handle}`} className="group grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-2sm text-gray-900 fon-inter leading-relaxed font-light max-w-xl">
            ...
            <div className="flex flex-wrap font-inter items-center gap-8 pt-4">
              ...
              <div className="ml-0 md:ml-1 mt-2 md:mt-0 flex items-center gap-4">
                ...
                <button
                  ...
                  className="p-[14px] border border-gray-200 font-inter text-gray-400 hover:text-black hover:border-black transition-colors rounded-none bg-white"
