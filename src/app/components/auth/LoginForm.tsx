    ...
    <form action={formAction} className="space-y-6 lg:space-y-8">
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          <label htmlFor="password" className="block text-[10px] font-inter font-bold tracking-[0.2em] text-[#6c3518] uppercase">
            Password
          </label>
          <Link
            href="/forgot-password"
            className="text-[9px] font-inter uppercase tracking-wider text-[#6c3518]/60 hover:text-[#6c3518] border-b border-transparent hover:border-[#6c3518]/20 transition-all"
          >
            Forgot?
          </Link>
        </div>
      ...
      <div className="text-center pt-2">
        <p className="text-sm font-inter text-gray-400 font-light">
          New to Indevie?{" "}
          <Link href="/register" className="text-[#6c3518] font-inter font-medium hover:text-black transition-all ml-1 underline underline-offset-4 decoration-[#6c3518]/20">
            Create account
          </Link>
        </p>
      </div>
