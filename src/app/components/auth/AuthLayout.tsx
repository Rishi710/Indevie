      ...
      <div className="relative flex items-center justify-center h-full px-6 py-12 lg:px-12 bg-[#f5f1e6] lg:bg-white/40">
        ...
        >
          <div className="mb-6 lg:mb-8">
            <h1 className="text-2xl lg:text-3xl font-inter text-[#6c3518] italic mb-3 leading-tight">{title}</h1>
            {subtitle && (
              <p className="text-gray-500 font-light font-inter tracking-wide text-xs lg:text-sm">{subtitle}</p>
            )}
          </div>

          <div className="bg-white/80 lg:bg-transparent font-inter backdrop-blur-sm lg:backdrop-blur-none p-6 lg:p-0 rounded-2xl shadow-xl shadow-[#6c3518]/5 lg:shadow-none border border-white/20 lg:border-none">
            {children}
          </div>
        </motion.div>
      </div>
