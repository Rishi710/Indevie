...
import { resetByUrlAction } from "@/app/actions/auth";
...
interface ResetByUrlFormProps {
    resetUrl: string;
}

export default function ResetByUrlForm({ resetUrl }: ResetByUrlFormProps) {
    const [state, formAction, isPending] = useActionState(resetByUrlAction, initialState);
