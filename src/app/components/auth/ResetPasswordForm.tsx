...
export default function ResetPasswordForm({ customerId, resetToken }: ResetPasswordFormProps) {
    ...
    return (
        <div className="w-full max-w-md mx-auto p-6 bg-white rounded-2xl shadow-xl shadow-[#6c3518]/5 border border-[#6c3518]/5">
            <form action={formAction} className="space-y-6">
                ...
                {state.error && (
                    <div className="bg-red-50 border font-inter border-red-100 text-red-600 px-4 py-2 rounded-xl text-xs font-medium animate-in fade-in slide-in-from-top-1">
                        {state.error}
                    </div>
                )}
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <input
                                ...
                                className="w-full px-5 py-3.5 border border-[#6c3518]/10 rounded-xl bg-[#f5f1e6]/10 focus:outline-none focus:border-[#6c3518]/40 focus:bg-white transition-all text-sm font-inter text-[#6c3518] placeholder:text-gray-300"
                            />
                            <button
                                type="button"
                ...
                <div className="pt-4">
                    ...
                    >
                        {isPending ? (
                            <span className="flex items-center justify-center font-inter gap-2">
