          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
            ...
            >
              <div className="space-y-6 md:space-y-8">
                <p className="text-[10px] md:text-xs font-inter font-bold tracking-[0.3em] uppercase text-red-800">
                  Introducing Genurveda™
                </p>

                <h2 className="text-3xl md:text-4xl lg:text-4xl font-inter font-bold leading-[1.1] text-[#6c3518]">
                  Ancient Rituals. Updated Expectations.
                </h2>

                <div className="space-y-4 text-sm md:text-base text-[#6c3518]/80 leading-relaxed font-inter">
                  <p>
                ...
                <div className="pt-4">
                  <Link href="/about">
                    <button className="bg-[#6c3518] text-[#f5f1e6] px-10 py-4 rounded-[10px] border-1 border-[#6c3518] text-xs md:text-sm font-inter font-medium tracking-wider hover:bg-white hover:text-[#6c3518] hover:border-[#6c3518] transition-all active:scale-95 shadow-lg">
                      Know More About Us
                    </button>
                  </Link>
                </div>
